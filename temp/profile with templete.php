            ...
            <div class="col-lg-10">
                <div class="profile-section">
                    ...
                    <div class="profile-info">
                        ...
                        <input type="text" class="form-control" id="name" value="<?php echo htmlspecialchars($userName); ?>">
                        
                        <label for="email">E-mail</label>
                        <input type="email" class="form-control" id="email" value="<?php echo htmlspecialchars($userEmail); ?>">
                        
                        <div class="email-confirmation">
                            Your email is not confirmed. Please check your inbox.
                            <button class="btn-resend">Resend confirmation</button>
                        </div>
                    </div>
