...
<body>
  ...
  <main>
    ...
    <div class="welcome-message">
      ...
      <p>Manage appointments, services, and feedback from here.</p>
    </div>
    ...
    <div class="nav-buttons">
      <button onclick="location.href='appointments.html'">Manage Appointments</button>
      <button onclick="location.href='services.html'">Manage Services</button>
